...
<%
   ...
   flag=false
      ...
      sql="select [ID],[City],[PersonName],[Nick]," & _
	  	"[Sex],[Age],[Weight],[Height],[aboutme],[aboutyou],[phone],[email],[Photo1],[pattern],[dream_life],[living],[favorite_eat],[favorite_drink],[interest] from Persons where ID>5000 order by [ID] desc" 
